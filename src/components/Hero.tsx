...
export const Hero = () => {
  return (
    <>
      <Container id="hero" className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Revolutionizing Colorectal Cancer Detection
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Accurate, Fast, and AI-Powered Detection Through Deep Learning on
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <img
              src="https://plus.unsplash.com/premium_photo-1670981098414-432189d7973c?q=80&w=1948&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              width="616"
              height="617"
              className={'object-cover h-[616px] w-[617px]'}
      ...
      <Container>
        <div className="flex flex-col justify-center bg-slate-300 p-8 rounded-lg">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            M. Tech Dissertation Project
          </div>

          <div className="flex flex-col flex-wrap items-center justify-center gap-5 mt-10 ">
            <div className="flex gap-20">
              <p className="text-2xl font-bold mr-20">Name</p>
              <p className="text-2xl">Souhardya Bose</p>
            </div>
            <div className="flex gap-20">
